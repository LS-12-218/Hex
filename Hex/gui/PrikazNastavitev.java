...
public class PrikazNastavitev extends JPanel implements ActionListener, ChangeListener {
	...
	NastavitveIgralec p1; //Platno z nastavitvami za rdeèega igralca
	NastavitveIgralec p2; //Platno z nastavitvami za modrega igralca
	NastavitveVelikost p3; //Nastavitev velikosti plošèe
	JPanel p4 = new JPanel(); //Platno z gumbom "Zaèni"
	...
	private Igralec novIgralec(int tezavnost) {
		//Inteligenca raèunalnika glede na izbrano težavnost
	...
	public void prikazi() {
		//Prikaže pogovorno okno z vsemi nastavitvami
	...
	public void stateChanged(ChangeEvent e) {
		if (e.getSource() == p1.tezavnost) {
			this.tezavnostRdeci = p1.tezavnost.getValue();
			p1.posodobiTezavnost();
		}
		else if (e.getSource() == p2.tezavnost) {
			this.tezavnostModri = p2.tezavnost.getValue();
			p2.posodobiTezavnost();
		}
		else if (e.getSource() == p3.velikost) {
			this.velikost = p3.velikost.getValue();
			p3.posodobiVelikost();
		}
	}
